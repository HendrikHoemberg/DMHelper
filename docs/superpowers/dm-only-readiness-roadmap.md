...
**Current NEXT item:** 3 — Rollable tables corrective verification
...
| 3 | Rollable tables and integrations | `IN_PROGRESS` | 2 | Atmosphere delivery items 1–2 | [Corrective implementation plan](plans/2026-07-18-rollable-tables-corrective-implementation.md) | Correct API DTOs, campaign-aware validation, complete authoring/rolling UI, consequence state machine, runnable package fidelity, real browser acceptance, and focused/full tests pass. |
...
- **Corrective audit (2026-07-18):** row 3 was reopened after runtime review found recursive JPA API serialization, incomplete reference/management UI, disconnected roll/draft surfaces, campaign-scope validation leaks, non-runnable imported weighted tables, incomplete package dry-run bounds, consequence-state errors, and service-direct browser evidence. The approved [corrective design](specs/2026-07-18-rollable-tables-corrective-design.md) and [implementation plan](plans/2026-07-18-rollable-tables-corrective-implementation.md) govern closure.
