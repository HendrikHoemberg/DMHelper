...
This directory documents the architecture of DMHelper.

- [Modules and Ownership](modules-and-ownership.md) — Package map and module responsibilities.
- [Import/Export Flow](import-export-flow.md) — Campaign package V2 import pipeline stages and export adapter order.
